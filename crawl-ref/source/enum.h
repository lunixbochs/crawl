...
enum ability_type
{
    ...
    // TSO
    ABIL_TSO_DIVINE_SHIELD = 210,
    ABIL_TSO_CLEANSING_FLAME,
    ABIL_TSO_SUMMON_DIVINE_WARRIOR,
    // Kiku
    ABIL_KIKU_RECEIVE_CORPSES = 220,
    ABIL_KIKU_TORMENT,
    // Yredelemnul
    ABIL_YRED_INJURY_MIRROR = 230,
    ...
    // Vehumet - none at present, but 240-249 is reserved just in case
    // Okawaru
    ABIL_OKAWARU_HEROISM = 250,
    ABIL_OKAWARU_FINESSE,
    // Makhleb
    ABIL_MAKHLEB_MINOR_DESTRUCTION = 260,
    ABIL_MAKHLEB_LESSER_SERVANT_OF_MAKHLEB,
    ABIL_MAKHLEB_MAJOR_DESTRUCTION,
    ABIL_MAKHLEB_GREATER_SERVANT_OF_MAKHLEB,
    // Sif Muna
    ABIL_SIF_MUNA_CHANNEL_ENERGY = 270,
    ABIL_SIF_MUNA_FORGET_SPELL,
    // Trog
    ABIL_TROG_BURN_SPELLBOOKS = 280,
    ABIL_TROG_BERSERK,
    ABIL_TROG_REGEN_MR,
    ABIL_TROG_BROTHERS_IN_ARMS,
    // Elyvilon
    ABIL_ELYVILON_LIFESAVING = 290,
...
enum book_type
{
    ...
    BOOK_NORMAL_UNUSED_4,
    BOOK_NORMAL_UNUSED_5,
    BOOK_NORMAL_UNUSED_6,
    BOOK_NORMAL_UNUSED_7,
...
enum dungeon_feature_type
{
    ...
    DNGN_RETURN_FROM_ORCISH_MINES = 450,
    ...
    DNGN_EXPLORE_HORIZON = 550, // dummy for redefinition
...
enum item_status_flag_type  // per item flags: ie. ident status, cursed status
{
    ...
    ISFLAG_SUMMONED          = 0x20000000,  // Item generated on a summon
    ISFLAG_DROPPED_BY_ALLY   = 0x40000000,  // Item was dropped by an ally
};
