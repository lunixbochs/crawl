...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_FELID,           SK_MACES_FLAILS,  -99),
    APT(SP_FELID,           SK_POLEARMS,      -99),
    APT(SP_FELID,           SK_STAVES,        -99),
    APT(SP_FELID,           SK_SLINGS,        -99),
    APT(SP_FELID,           SK_BOWS,          -99),
    APT(SP_FELID,           SK_CROSSBOWS,     -99),
